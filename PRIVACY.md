...
English API responses omit untranslated Chinese source-body text and page excerpts until an English translation is cached. Source PDFs and source-language extraction remain local, while page numbers, integrity metadata, translation status, and external source links remain available for verification.
